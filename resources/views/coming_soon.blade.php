...
<div class="card" style="text-align:center; padding:5rem 2rem;">
    ...
    <p style="color:var(--text-muted); max-width:500px; margin:0 auto 2rem auto;">
        We are rapidly building Walkwel's expansive feature set. This specific module is currently deep in development and will be released in an upcoming milestone.
    </p>
